...
export default function Footer(): React.ReactElement {
  return (
    <footer className="w-full border-t border-gray-200  py-6 sm:px-10">
      <div className="mx-auto flex w-full max-w-screen-xl flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 text-center text-[12px] text-gray-600">
